 ...
 * SPDY frames flowing in and out using the {@link manon.netty.example.D_http.spdy.client.SpdyFrameLogger}.
 *
 * <p>
 ...
 * <p>
 * To start, run {@link manon.netty.example.D_http.spdy.server.SpdyServer} with the JVM parameter:
 ...
 * information.
 * <p>
 * After that, you can run {@link manon.netty.example.D_http.spdy.client.SpdyClient}, also settings the JVM parameter
 * mentioned above.
 * <p>
 ...
 * </pre>
 */
package manon.netty.example.D_http.spdy.client;
